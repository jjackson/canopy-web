"""canopy_runs — the Django-free run-lifecycle core.
...
`canopy_runs.drive`). Host apps (canopy-web, ace-web) supply their own
...
(+ pyyaml for the Drive parsers, imported under `canopy_runs.drive`). The Google
